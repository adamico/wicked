...
public class ServerConfig {
    ...
    static {
        ...
        LOW_WICKEDNESS_VALUE = SERVER_BUILDER.comment("Wickedness amount for animals tagged with #wicked:low_wickedness_entities")
                .defineInRange("low_wickedness", 10, 1, 20);
        MID_WICKEDNESS_VALUE = SERVER_BUILDER.comment("Wickedness amount for animals tagged with #wicked:mid_wickedness_entities")
                .defineInRange("mid_wickedness", 50, 21, 60);
        HIGH_WICKEDNESS_VALUE = SERVER_BUILDER.comment("Wickedness amount for animals tagged with #wicked:high_wickedness_entities")
