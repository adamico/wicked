package me.kc00l.wickedness.common.command;
...
public class ModCommands {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("wickedness")
    ...
    private static int setWickednessDecay(CommandSourceStack source, boolean enable) {
        ...
        String translatableKey = enable ? "command.wickedness.set_wickedness_decay.on" : "command.wickedness.set_wickedness_decay.off";
    ...
    private static int clearWickedness(CommandSourceStack source) {
        ...
        player.sendSystemMessage(Component.translatable("command.wickedness.clear_wickedness"));
        return 1;
    }
    ...
    private static int setMaxWickedness(CommandSourceStack source) {
        ...
        player.sendSystemMessage(Component.translatable("command.wickedness.set_max_wickedness"));
        return 1;
    }
}
